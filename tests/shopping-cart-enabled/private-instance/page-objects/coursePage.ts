...
export class CoursePage {
  ...
  constructor(page: Page) {
    ...
    this.courseCardThreeQA = page.getByRole('link', { name: 'Linguine Law School Corporate' });
    ...
    this.courseCardThreeStaging = page.getByRole('link', { name: 'Linguine Law School Intro to' });
